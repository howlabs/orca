    ...
    try {
      if (fileExistedOnLoad) {
        ...
        const migratedExperimentalActivity = experimentalActivityDefaultedOffForAllUsers
          ...
          : false
        const showAutomationsButtonDefaultedOffForAllUsers =
          parsed.settings?.showAutomationsButtonDefaultedOffForAllUsers === true
        const migratedShowAutomationsButton = showAutomationsButtonDefaultedOffForAllUsers
          ? (parsed.settings?.showAutomationsButton ?? false)
          : false
        const showMobileButtonDefaultedOffForAllUsers =
          parsed.settings?.showMobileButtonDefaultedOffForAllUsers === true
        const migratedShowMobileButton = showMobileButtonDefaultedOffForAllUsers
          ? (parsed.settings?.showMobileButton ?? false)
          : false
        if (!showAutomationsButtonDefaultedOffForAllUsers || !showMobileButtonDefaultedOffForAllUsers) {
          this.loadNeedsSave = true
        }
        ...
        const migratedSourceControlGroupOrder =
        ...
        result = {
          ...
          settings: {
            ...
            showAutomationsButton: migratedShowAutomationsButton,
            showAutomationsButtonDefaultedOffForAllUsers: true,
            showMobileButton: migratedShowMobileButton,
            ...
            ...migratedSourceControlGroupOrder,
