...
export type GlobalSettings = {
  ...
  /** Legacy preferred Source Control group order. New profiles use the default order. */
  ...
  /** One-shot migration for default-off sidebar Automations shortcut. */
  ...
  /** One-shot migration for default-off sidebar Orca Mobile shortcut. */
  showMobileButtonDefaultedOffForAllUsers?: boolean
  ...
  /** Legacy opt-out for the graduated worktree-card layout. */
