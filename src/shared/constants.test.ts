...
describe('getDefaultSettings', () => {
  ...
  it('does not persist a Source Control group order preference by default', () => {
    expect(getDefaultSettings('/tmp').sourceControlGroupOrder).toBeUndefined()
  })
  ...
  it('uses the graduated worktree card style by default', () => {
    expect(getDefaultSettings('/tmp').experimentalNewWorktreeCardStyle).toBe(true)
  })
