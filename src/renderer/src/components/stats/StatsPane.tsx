...
function SummaryMetric({ label, value, icon }: SummaryMetricProps): React.JSX.Element {
  return (
      ...
      {summary ? (
        <div className="space-y-3">
          {summary.totalAgentsSpawned === 0 && summary.totalPRsCreated === 0 ? (
            ...
            <>
              <div className="divide-y divide-border/60 rounded-lg border border-border/60 sm:grid sm:grid-cols-3 sm:divide-x sm:divide-y-0">
                <SummaryMetric
